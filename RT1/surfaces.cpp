 ...
 */
Sphere::Sphere(float x, float y, float z, float r, Color mtl_color) {
	center = Vec3(x, y, z);
	this->r = r;
 ...
 */
void Sphere::print() {
	printf("Sphere:= Center: (%.3f, %.3f, %.3f) R: %.3f Color: (%.3f, %.3f, %.3f)\n", center.x, center.y, center.z, r, 
					mtl_color.r, mtl_color.g, mtl_color.b);
}
 ...
 * @param mtl_color	the color of the material
 */
Ellipsoid::Ellipsoid(float x, float y, float z, float a, float b, float c, Color mtl_color) {
	center = Vec3(x, y, z);
...
void Ellipsoid::print() {
	printf("Ellipsoid:= Center: (%.3f, %.3f, %.3f) Axis: (%.3f, %.3f, %.3f) Color: (%.3f, %.3f, %.3f)\n", center.x, center.y, center.z, a, b, c, mtl_color.r, mtl_color.g, mtl_color.b);
}
